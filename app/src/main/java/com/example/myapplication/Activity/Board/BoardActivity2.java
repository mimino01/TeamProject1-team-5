...
public class BoardActivity2 extends AppCompatActivity implements OnMapReadyCallback, Overlay.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boardAdapter = new BoardAdapter(BoardActivity2.this,boardArrayList);
   ...
   /* }
    ...
    public boolean onClick(@NonNull Overlay overlay) {
        if (overlay instanceof Marker) {
            String message = "";
            if (overlay == marker1) {
                Toast.makeText(getApplicationContext(),abc[0][0] , Toast.LENGTH_LONG).show();
